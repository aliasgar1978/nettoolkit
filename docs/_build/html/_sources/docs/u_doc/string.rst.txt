...
For More Details check out the API docuementation for STR class.

	* `STR <https://nettoolkit.readthedocs.io/en/latest/docs/t_doc/__gpl.html#nettoolkit.gpl.STR>`_
