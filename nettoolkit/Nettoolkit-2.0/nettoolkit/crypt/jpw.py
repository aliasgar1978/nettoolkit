...
def doller9_enc(plaintext, salt = None):
...
def file_passwords_dec(input_file, output_file):
...
def file_passwords_mask(input_file, output_file):
...
__all__ = ['doller9_dec',  'doller9_enc', 'file_passwords_dec',  'file_passwords_mask' ]
